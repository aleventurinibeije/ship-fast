...
<!-- This folder holds the active best-practice files for this project.
     ...
     - frontend.md ← frontend coding rules, test conventions, components patterns

     If your project is BE-only, create only backend.md and ignore frontend.md.
     If your project is FE-only, create only frontend.md and ignore backend.md.
-->
